...
- removed the evaluation modules, users just want to align_one their documents.
...
def align_one(sx, sy, mean_xy, variance_xy, bc):
...
def align(corpusx, corpusy, mean=1.0, variance=6.8, bc = BEAD_COSTS):
